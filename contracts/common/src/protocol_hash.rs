...
pub const DOMAIN_SET_STATE: &[u8] = b"LEAN/PUBLISHER_SET_STATE/V2";
pub const DOMAIN_SET_UPDATE: &[u8] = b"LEAN/PUBLISHER_SET_UPDATE/V2";
pub const DOMAIN_SET_POP: &[u8] = b"LEAN/PUBLISHER_SET_POP/V2";
